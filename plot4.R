...
plot( power2007$DateTime, power2007$Global_active_power, type ='l', xlab="", ylab="Global Active Power")

plot( power2007$DateTime, power2007$Voltage, type ='l', xlab="datetime", ylab="Voltage")
...
legend("topright", lty=1, lwd=1, col = c("black", "blue", "red"), legend = legend_text, cex=0.5, bty="n" )

plot( power2007$DateTime, power2007$Global_reactive_power, type ='l', xlab="datetime", ylab="Global_reactive_power")
